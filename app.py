...
def _get_allowed_origins() -> List[str]:
    ...
    # Support legacy/prod GitHub Pages hostname typo variants to avoid accidental CORS lockouts.
    alias_map = {
        "https://mouleesh-user.github.io": "https://moulesh-user.github.io",
        "https://moulesh-user.github.io": "https://mouleesh-user.github.io",
    }
    expanded: List[str] = []
    for origin in normalized:
        expanded.append(origin)
        alias = alias_map.get(origin)
        if alias:
